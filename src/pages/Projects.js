...
const Projects = () => {
    ...
    return (
        <div className="project-wrapper">
            ...
            <Card as={Link} to={'https://ling-king-fishing-a75c68586413.herokuapp.com'} className="third-project-card" bg="dark" style={{ width: '18rem'}}>
                <Card.Header style={{ color: "white"}}>Ling King Fishing</Card.Header>
